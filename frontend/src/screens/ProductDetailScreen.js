      ...
      >
        ...
        {images.length > 0 ? (
          <View style={styles.galleryContainer}>
            <Image
              source={{ uri: images[activeImageIndex].imageUrl }}
              style={styles.image}
              resizeMode="contain"
            />
            {images.length > 1 && (
...
const styles = StyleSheet.create({
  ...
  galleryContainer: { height: 420, backgroundColor: Colors.gray50, position: 'relative' },
  image:            { width: '100%', height: '100%' },
  imagePlaceholder: { height: 420, backgroundColor: Colors.gray50, alignItems: 'center', justifyContent: 'center' },
